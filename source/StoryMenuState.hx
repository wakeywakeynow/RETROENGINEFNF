...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...weekData.length)
		{
			...
			weekThing.antialiasing = !ClientPrefs.lowQuality;
		...
		for (char in 0...3)
		{
			...
			weekCharacterThing.antialiasing = !ClientPrefs.lowQuality;
		...
		leftArrow.antialiasing = !ClientPrefs.lowQuality;
		...
		sprDifficulty.antialiasing = !ClientPrefs.lowQuality;
		changeDifficulty();
		...
		rightArrow.antialiasing = !ClientPrefs.lowQuality;
